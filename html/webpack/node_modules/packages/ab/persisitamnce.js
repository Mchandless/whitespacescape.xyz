...
export const storage = {
  ...
  method: "localStorage", // supported methods are 'cookie' and 'localStorage'
  expiry: 30, // ignore entries that weren't touched this amount of days

  _load() {
    if (this.method === "cookie") this._store = getCookie(this.name) || {};
    else if (this.method === "localStorage")
      this._store = getLocalStorage(this.name, this.expiry) || {};
    else {
      console.warn(
        "VueA2B WARNING: No or invalid storage method. Data will not persist."
      );
      this._store = {};
    }
    return this._store;
